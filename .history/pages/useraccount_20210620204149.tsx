...
export default function Useraccount() {
  const { user, signOut } = useAuth() as useProvideAuthResult;
        ...
        <main className="flex flex-col flex-1 bg-gray-100">
          ...
          {user &&
            (user?.stripeRole !== 'free' ? (
              ...
              <div className="flex items-center justify-center h-screen my-auto overflow-x-hidden outline-none min-w-screen focus:outline-none">
                <div className="relative w-full max-w-lg p-5 mx-auto my-auto rounded-xl ">
                  <Pricing />
                </div>
              </div>
            ))}
