      ...
      <div className="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
        <div className="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
          ...
          >
            ...
            {!user && (
              <>
                <button className="justify-center px-4 py-2 mr-3 text-sm font-medium text-black bg-white bg-indigo-700 border border-transparent rounded-full shadow-sm outline-none mt-2inline-flex whitespace-nowrap ring-2 ring-offset-2 ring-indigo-500">
                  <span className="flex items-center justify-center">
