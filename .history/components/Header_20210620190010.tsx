          ...
          >
            ...
            {!user && (
              <>
                <button
                  type="button"
                  onClick={() => signinWithGoogle('useraccount')}
                  className="justify-center px-4 py-2 mr-3 text-sm font-medium text-black bg-white border border-transparent rounded-full shadow-sm mt-2inline-flex whitespace-nowrap hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                  <span className="flex items-center justify-center">
                    <img
                      src="/google.png"
                      alt="google logo"
                      className="w-5 mr-3 h5"
                    />{' '}
                    Sign in with Google
                  </span>{' '}
                </button>
